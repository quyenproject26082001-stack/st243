...
import com.tempttt.core.extensions.logEvent
...
import com.tempttt.core.extensions.startIntentLeftToRight
...
import com.tempttt.databinding.ActivityCustomizeBinding
...
import com.tempttt.ui.add_character.AddCharacterActivity
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (currentPath.isNullOrEmpty()) {
                val selectedItem = listToSubmit.firstOrNull {
                    it.isSelected &&
                    it.path != com.tempttt.core.utils.key.AssetsKey.NONE_LAYER &&
                    it.path != com.tempttt.core.utils.key.AssetsKey.RANDOM_LAYER
                }
