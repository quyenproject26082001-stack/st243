package com.tempttt.ui.my_creation.view_model
...
import com.tempttt.data.model.MyAlbumModel
        ...
        InternetHelper.checkInternet(context) { result ->
            if (result == HandleState.SUCCESS) {
                ...
                val dialog = com.tempttt.dialog.YesNoDialog(
                    context,
                    com.tempttt.R.string.no_internet,
                    com.tempttt.R.string.please_check_your_internet,
                    isError = true
                )
                dialog.show()
                dialog.onYesClick = {
