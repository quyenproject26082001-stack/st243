package com.tempttt.core.utils

import android.content.Context
import androidx.core.content.ContextCompat
import androidx.lifecycle.MutableLiveData
import com.tempttt.R
//import com.tempttt.core.custom.layout.LayoutPresets
import com.tempttt.data.model.IntroModel
import com.tempttt.data.model.LanguageModel
...
object DataLocal {
    val shimmer =
        Shimmer.AlphaHighlightBuilder().setDuration(1800).setBaseAlpha(0.3f).setHighlightAlpha(0.6f)
