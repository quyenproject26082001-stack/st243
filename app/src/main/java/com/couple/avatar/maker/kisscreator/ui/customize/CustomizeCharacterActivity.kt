        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (currentPath.isNullOrEmpty()) {
                val selectedItem = listToSubmit.firstOrNull {
                    it.isSelected &&
                    it.path != com.couple.avatar.maker.kisscreator.core.utils.key.AssetsKey.NONE_LAYER &&
                    it.path != com.couple.avatar.maker.kisscreator.core.utils.key.AssetsKey.RANDOM_LAYER
                }
