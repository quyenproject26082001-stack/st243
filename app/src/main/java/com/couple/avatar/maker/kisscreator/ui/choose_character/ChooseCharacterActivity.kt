...
import com.couple.avatar.maker.kisscreator.ui.random_character.RandomCharacterActivity
...
import com.couple.avatar.maker.kisscreator.databinding.ActivityChooseCharacterBinding
...
class ChooseCharacterActivity : BaseActivity<ActivityChooseCharacterBinding>() {
    ...
    private fun checkInternetForAPICharacters(data: ArrayList<com.couple.avatar.maker.kisscreator.data.model.custom.CustomizeModel>) {
