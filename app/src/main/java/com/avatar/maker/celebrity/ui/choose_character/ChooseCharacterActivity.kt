...
import com.avatar.maker.celebrity.ui.random_character.RandomCharacterActivity
...
import com.avatar.maker.celebrity.databinding.ActivityChooseCharacterBinding
...
class ChooseCharacterActivity : BaseActivity<ActivityChooseCharacterBinding>() {
    ...
    private fun checkInternetForAPICharacters(data: ArrayList<com.avatar.maker.celebrity.data.model.custom.CustomizeModel>) {
